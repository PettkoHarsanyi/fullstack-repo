...
export class AuthStorageService {
  ...
  saveUser(loginResponse: LoginResponse| null){
    ...
    sessionStorage.setItem(AuthStorageService.TOKEN_KEY, loginResponse.access_token);
    sessionStorage.setItem(AuthStorageService.USER_KEY, JSON.stringify(loginResponse.user));
